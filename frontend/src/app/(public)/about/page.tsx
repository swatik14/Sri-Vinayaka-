...
export default function AboutPage() {
  ...
  const milestones = [
    { year: '1820', en: 'Temple founded by local devotees in the heart of Nagdevanahalli', kn: 'ನಾಗದೇವನಹಳ್ಳಿಯ ಹೃದಯಭಾಗದಲ್ಲಿ ಸ್ಥಳೀಯ ಭಕ್ತರಿಂದ ದೇವಾಲಯ ಸ್ಥಾಪನೆ' },
  ...
  const features = [
    { en: 'Traditional Dravidian Architecture', kn: 'ಸಾಂಪ್ರದಾಯಿಕ ದ್ರಾವಿಡ ವಾಸ್ತುಶಿಲ್ಪ' },
    { en: '10+ Cultural Programs Annually', kn: 'ವಾರ್ಷಿಕ 10+ ಸಾಂಸ್ಕೃತಿಕ ಕಾರ್ಯಕ್ರಮಗಳು' },
    { en: 'Daily Annadana — Free Meals', kn: 'ದೈನಂದಿನ ಅನ್ನದಾನ — ಉಚಿತ ಊಟ' },
    { en: 'Vedic Education & Scholarships', kn: 'ವೈದಿಕ ಶಿಕ್ಷಣ ಮತ್ತು ವಿದ್ಯಾರ್ಥಿ ವೇತನ' },
    { en: 'Health Camps for the Community', kn: 'ಸಮುದಾಯಕ್ಕಾಗಿ ಆರೋಗ್ಯ ಶಿಬಿರಗಳು' },
    { en: 'Distribution of Prasad Daily', kn: 'ಪ್ರತಿದಿನ ಪ್ರಸಾದ ವಿತರಣೆ' },
  ];
    ...
    <div>
      ...
      <div className="page-header">
        <div className="max-w-4xl mx-auto px-4 relative z-10 reveal">
          <p className="text-temple-gold text-lg mb-2 animate-fade-in">ॐ गण गणपतये नमः</p>
        ...
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div className="reveal-left">
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                {language === 'kn'
                  ? 'ಶ್ರೀ ಕಾರ್ಯಸಿದ್ಧಿ ವಿನಾಯಕ ದೇವಾಲಯ 1820 ರಲ್ಲಿ ನಾಗದೇವನಹಳ್ಳಿ, ಬೆಂಗಳೂರಿನಲ್ಲಿ ಸ್ಥಾಪಿಸಲಾಯಿತು. ಸ್ಥಳೀಯ ಭಕ್ತರ ಗುಂಪಿನಿಂದ ನಿರ್ಮಿಸಲಾದ ಸಣ್ಣ ಗುಡಿಯು ಇಂದು ಭವ್ಯ ದೇವಾಲಯ ಸಂಕೀರ್ಣವಾಗಿ ಬೆಳೆದಿದೆ.'
                  : 'Sri Sri Sri Karyasiddhi Vinayaka Temple was established in 1820 at Nagdevanahalli, Bangalore. Originally built as a small shrine by a group of local devotees, it has grown into a grand temple complex that serves as a spiritual anchor for the community.'}
              </p>
              <p>
                {language === 'kn'
          ...
          <div className="reveal-right bg-temple-gradient rounded-2xl p-8 text-white text-center relative overflow-hidden">
            <span className="absolute text-[200px] font-bold text-white/5 -top-10 -right-10 pointer-events-none animate-float-slow">ॐ</span>
            <div className="text-6xl mb-4 text-temple-gold font-bold animate-float">ॐ</div>
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="reveal-scale"><p className="text-2xl font-bold text-temple-gold">5000+</p><p className="text-xs text-white/60">Daily Devotees</p></div>
              <div className="reveal-scale" style={{ transitionDelay: '0.1s' }}><p className="text-2xl font-bold text-temple-gold">50+</p><p className="text-xs text-white/60">Annual Events</p></div>
              <div className="reveal-scale" style={{ transitionDelay: '0.2s' }}><p className="text-2xl font-bold text-temple-gold">500+</p><p className="text-xs text-white/60">Daily Meals</p></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-temple-cream-dark">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="section-title text-center mb-10 reveal">{t('ourHistory')} Timeline</h2>
          <div className="relative">
            <div className="absolute left-1/2 -translate-x-0.5 top-0 bottom-0 w-0.5 bg-temple-gold/30 hidden md:block" />
            <div className="space-y-8">
              {milestones.map((m, i) => (
                <div key={m.year} className={`flex gap-6 items-start ${i % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'} ${i % 2 === 0 ? 'reveal-left' : 'reveal-right'}`}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="section-title text-center mb-10 reveal">What We Do</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map(({ en, kn }, i) => (
              <div key={en} className="card-hover p-6 flex items-start gap-4 reveal-scale"
      ...
      <section className="py-16 bg-temple-gradient">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          <h2 className="text-3xl font-heading font-bold text-temple-gold mb-6 reveal">{t('vision')}</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white/10 border border-white/20 rounded-2xl p-6 reveal-left">
            ...
            <div className="bg-white/10 border border-white/20 rounded-2xl p-6 reveal-right">
